...
TeleportService:Teleport(game.PlaceId, player)
    ...
    Player = Window:Tab({ Title = "loc:Player_TAB", Icon = "user" }),
    Auto = Window:Tab({ Title = "loc:AUTO_TAB", Icon = "repeat-2" }),
    Visuals = Window:Tab({ Title = "loc:VISUALS_TAB", Icon = "camera" }),
    ESP = Window:Tab({ Title = "loc:ESP_TAB", Icon = "eye" }),
    Utility = Window:Tab({ Title = "Utility", Icon = "wrench"}),
    Teleport = Window:Tab({ Title = "Teleport", Icon = "navigation" }),
    Settings = Window:Tab({ Title = "loc:SETTINGS_TAB", Icon = "settings" })
}
